...
<svelte:head>
  <title>Sheetlytics</title>
</svelte:head>

<div class="max-w-screen-md mx-auto md:px-6 px-4">
...
<div class="mt-16 bg-yellow-50">
  <div class="max-w-screen-md mx-auto md:px-6 px-4 py-12 text-center bg-yellow-50">
